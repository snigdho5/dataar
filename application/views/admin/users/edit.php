            ...
            <div class="container">
                <div class="col-md-11">
                    ...
                    <form method="POST" action="<?= base_url('admin/updateuser') ?>" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-6 ">
                            <label for="status">KYC Verified : </label> <span> View PAN Card:
                                ...
                                ?></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                 <?php if ($user->kyc_address_file != '') {?>
                                <span> View Address Proof (<?php echo $user->address_proof_type;?>):
                                <a href="#" class="btn-view-kyc" data-kyc-file="<?php echo  $user->kyc_address_file; ?>"><img style="max-height: 20px; max-width:30px;" src="data:image/png;base64,<?php echo  $user->kyc_address_file; ?>" alt="Kyc address proof" /></a>
                                </span>
                                <?php
                                } 
                                ?>
