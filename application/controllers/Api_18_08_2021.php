    ...
    public function campaign_details_post()
    {
        if ($this->verify_token()) {
            ...
            if (count($data)) {
                ...
                $donations = $this->api_model->getDonations(array('donation_master.campaign_id' => $campaign_id, 'donation_master.user_id' => $user_id));
    ...
    public function campaign_like_dislike_post()
    {
        ...
        if ($this->verify_token()) {
            ...
            if ($user_id != '' && $campaign_id != '') {
                $result = $this->api_model->campaignLikeDislike($user_id, $campaign_id, $comment);
